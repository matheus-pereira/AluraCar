...
angular.module('starter', ['ionic', 'idf.br-filters', 'ngCordova', 'ionic-datepicker', 'ui.utils.masks'])
...
.run(function($ionicPlatform, DatabaseValues) {
  $ionicPlatform.ready(function() {
    ...
    DatabaseValues.bancoDeDados.transaction(function(transacao){
      transacao.executeSql('CREATE TABLE IF NOT EXISTS usuarios(id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, nome VARCHAR(300), email VARCHAR(300))', []);
    });
  });
})
